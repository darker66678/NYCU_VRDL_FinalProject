...
if __name__=='__main__':
    ...
    parser.add_argument('--csv', default='./data/stage_2_sample_submission.csv', type=str, help='the sample cvs file path, ex : stage_2_sample_submission.csv')
    parser.add_argument('--target', default='answer.csv', type=str, help='the output csv file name, ex : answer.csv')
